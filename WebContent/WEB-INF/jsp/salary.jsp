						...
						<div class="col-md-4">
							<div class="ibox float-e-margins">
								...
								<div class="ibox-content">
									<div align="center">
										<div class="row">
											<span class="label pull-left">基本工资</span>
											<span class="label label-info pull-right" id="salary_base">&yen;<span>${mySalary.S_BASIC}</span></span>
										</div>
										<br />
										<div class="row">
											<span class="label pull-left">奖金</span>
											<span class="label label-info pull-right" id="salary_jj">&yen;<span>${mySalary.S_BASIC}</span></span>
										</div>
										<br />
										<div class="row">
											<span class="label pull-left">补贴</span>
											<span class="label label-info pull-right" id="salary_butie">&yen;<span>${mySalary.S_BASIC}</span></span>
										</div>
										<br />
										<div class="row">
											<span class="label pull-left">总额</span>
											<span class="label label-success pull-right" id="salary">&yen;<span>${mySalary.S_BASIC}</span></span>
										</div>
									</div>
								</div>
							</div>
					...
					<div class="row">
						<div class="col-sm-12">
							<div class="ibox float-e-margins">
								...
								<div class="ibox-content">
									<div style="height: 200px;" id="salary_year"></div>
								</div>
							</div>
						</div>
					</div>
